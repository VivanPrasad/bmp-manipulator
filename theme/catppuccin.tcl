# The Catpuccin theme by VivanPrasad.

package require Tk 8.6

namespace eval ttk::theme::catppuccin {

    variable version 1.0
    package provide ttk::theme::catppuccin $version
    variable colors
    array set colors {
        -fg             "#cdd6f4"
        -bg             "#181825"
    ...
    LoadImages [file join [file dirname [info script]] catppuccin]

    # Sets Cascadia Code font, falls back to Arial if not installed
    font create CascadiaCode -family "Cascadia Code" -size 12 -weight normal -slant roman -underline 0 -overstrike 0
    
    # Settings
    ttk::style theme create catppuccin -parent default -settings {
        ttk::style configure . \
